...
### Notice: This file was provided as open source
### I just added it to show additional methods used in my step definitions
### Credit goes to: https://github.com/bmabey/email-spec/blob/master/rails_generators/email_spec/templates/email_steps.rb
#
...
module EmailHelpers
  def current_email_address
    ...
    last_email_address || "christian@russ.de"
  end
end
